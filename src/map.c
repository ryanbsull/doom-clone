...
int default_map() {
  ...
  current_map.sections[0].walls[0].end.x = 20;
  current_map.sections[0].walls[0].end.y = 0;
  current_map.sections[0].walls[1].start.x = 20;
  current_map.sections[0].walls[1].start.y = 0;
  current_map.sections[0].walls[1].end.x = 20;
  current_map.sections[0].walls[1].end.y = 20;
  current_map.sections[0].walls[2].start.x = 20;
  current_map.sections[0].walls[2].start.y = 20;
  current_map.sections[0].walls[2].end.x = 0;
  current_map.sections[0].walls[2].end.y = 20;
  current_map.sections[0].walls[3].start.x = 0;
  current_map.sections[0].walls[3].start.y = 20;
